...
<br>
<h3 class="text-uppercase text-rose">Formations liées à l'établissement <strong>{{ $etablissement->nom }}</strong></h3>
...
<div class="row">
  ...
  <div class="col-sm-12 col-lg-12 mb-1">
    ...
    <form class="form-inline col-lg-12" action="{{ route('admin_etablissement_formation_add') }}" method="POST">
      {{ csrf_field() }}
      ...
      <div class="input-group col-lg-12">
        <div class="input-group-addon">Lier une nouvelle formation à cet établissement</div>
    ...
    <table class="table table-hover">
      ...
      <thead>
        <tr>
          ...
          <th scope="col">Etablissements liés</th>
