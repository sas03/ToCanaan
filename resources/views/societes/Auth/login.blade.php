@extends('layouts.master') @section('title', 'Espace professionnels')
...
<div class="row justify-content-center">
  <div class="col-md-6 box-form">
    ...
    <form class="form-horizontal" method="POST" action="{{ route('societe_login') }}">
        {{ csrf_field() }}
...
<div class="row justify-content-center">
  ...
  <div class="col-md-6 box-form">
    ...
    <a class="btn bg-jaune btn-inscription" href="{{ route('societe_register') }}">
        S'inscrire
    </a>
  </div>
</div>
