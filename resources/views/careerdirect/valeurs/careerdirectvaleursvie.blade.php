...
@section('content')
  <div class="custom-card">
    <p><?php echo $documents[114]->nodeValue, PHP_EOL ?></p>
    <p><?php echo $documents[115]->nodeValue, PHP_EOL ?></p>

    <h4 class="cdreport-header cdreport-header-alt">VOS NEUF POINTS PRIORITAIRES RELATIFS A VOS OBJECTIFS DE VIE</h4>
    <div style="position: relative;">
      <div class="cdchart life_chart" style="position: relative;" data-highcharts-chart="39">
        <div class="highcharts-container" id="highcharts-78" style="position: relative; overflow: hidden; width: 938px; height: 400px; text-align: left; line-height: normal; z-index: 0; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); font-family: Dosis, sans-serif;">
          <img src="{{ asset('img/svg/chart37.svg') }}">
          <div class="highcharts-legend" style="position: absolute; left: 628px; top: 120px;">
              ...
              <div class="null" style="position: absolute; left: 0px; top: 0px;">
                <div class="highcharts-legend-item" style="position: absolute; left: 8px; top: 3px;">
                  <span style="position: absolute; white-space: nowrap; font-family: Dosis, sans-serif; font-size: 16px; color: rgb(255, 255, 255); font-weight: bold; cursor: pointer; margin-left: 0px; margin-top: 0px; left: 21px; top: 2px; fill: rgb(51, 51, 51);" zindex="2">
                    <div style="text-align: left; font-family:serif; width:300px;float:left;"><b><?php echo $documents_span[930]->nodeValue, PHP_EOL ?></b></div></span></div>
                    <div class="highcharts-legend-item" style="position: absolute; left: 8px; top: 20px;">
                      <span style="position: absolute; white-space: nowrap; font-family: Dosis, sans-serif; font-size: 16px; color: rgb(255, 255, 255); font-weight: bold; cursor: pointer; margin-left: 0px; margin-top: 0px; left: 21px; top: 2px; fill: rgb(51, 51, 51);" zindex="2">
                        <div style="text-align: left; font-family:serif; width:300px;float:left;"><b><?php echo $documents_span[931]->nodeValue, PHP_EOL ?></b></div></span></div>
                        <div class="highcharts-legend-item" style="position: absolute; left: 8px; top: 37px;">
                          <span style="position: absolute; white-space: nowrap; font-family: Dosis, sans-serif; font-size: 16px; color: rgb(255, 255, 255); font-weight: bold; cursor: pointer; margin-left: 0px; margin-top: 0px; left: 21px; top: 2px; fill: rgb(51, 51, 51);" zindex="2">
                            <div style="text-align: left; font-family:serif; width:300px;float:left;"><b><?php echo $documents_span[932]->nodeValue, PHP_EOL ?></b></div></span></div>
                            <div class="highcharts-legend-item" style="position: absolute; left: 8px; top: 54px;">
                              <span style="position: absolute; white-space: nowrap; font-family: Dosis, sans-serif; font-size: 16px; color: rgb(255, 255, 255); font-weight: bold; cursor: pointer; margin-left: 0px; margin-top: 0px; left: 21px; top: 2px; fill: rgb(51, 51, 51);" zindex="2">
                                <div style="text-align: left; font-family:serif; width:300px;float:left;"><b><?php echo $documents_span[933]->nodeValue, PHP_EOL ?></b></div></span></div>
                                <div class="highcharts-legend-item" style="position: absolute; left: 8px; top: 71px;">
                                  <span style="position: absolute; white-space: nowrap; font-family: Dosis, sans-serif; font-size: 16px; color: rgb(255, 255, 255); font-weight: bold; cursor: pointer; margin-left: 0px; margin-top: 0px; left: 21px; top: 2px; fill: rgb(51, 51, 51);" zindex="2">
                                    <div style="text-align: left; font-family:serif; width:300px;float:left;"><?php echo $documents_span[934]->nodeValue, PHP_EOL ?></div></span></div>
                                    <div class="highcharts-legend-item" style="position: absolute; left: 8px; top: 88px;">
                                      <span style="position: absolute; white-space: nowrap; font-family: Dosis, sans-serif; font-size: 16px; color: rgb(255, 255, 255); font-weight: bold; cursor: pointer; margin-left: 0px; margin-top: 0px; left: 21px; top: 2px; fill: rgb(51, 51, 51);" zindex="2">
                                        <div style="text-align: left; font-family:serif; width:300px;float:left;"><?php echo $documents_span[935]->nodeValue, PHP_EOL ?></div></span></div>
                                        <div class="highcharts-legend-item" style="position: absolute; left: 8px; top: 105px;">
                                          <span style="position: absolute; white-space: nowrap; font-family: Dosis, sans-serif; font-size: 16px; color: rgb(255, 255, 255); font-weight: bold; cursor: pointer; margin-left: 0px; margin-top: 0px; left: 21px; top: 2px; fill: rgb(51, 51, 51);" zindex="2">
                                            <div style="text-align: left; font-family:serif; width:300px;float:left;"><?php echo $documents_span[936]->nodeValue, PHP_EOL ?></div></span></div>
                                            <div class="highcharts-legend-item" style="position: absolute; left: 8px; top: 122px;">
                                              <span style="position: absolute; white-space: nowrap; font-family: Dosis, sans-serif; font-size: 16px; color: rgb(255, 255, 255); font-weight: bold; cursor: pointer; margin-left: 0px; margin-top: 0px; left: 21px; top: 2px; fill: rgb(51, 51, 51);" zindex="2">
                                                <div style="text-align: left; font-family:serif; width:300px;float:left;"><?php echo $documents_span[937]->nodeValue, PHP_EOL ?></div></span></div>
                                                <div class="highcharts-legend-item" style="position: absolute; left: 8px; top: 139px;">
                                                  <span style="position: absolute; white-space: nowrap; font-family: Dosis, sans-serif; font-size: 16px; color: rgb(255, 255, 255); font-weight: bold; cursor: pointer; margin-left: 0px; margin-top: 0px; left: 21px; top: 2px; fill: rgb(51, 51, 51);" zindex="2">
                                                    <div style="text-align: left; font-family:serif; width:300px;float:left;"><?php echo $documents_span[938]->nodeValue, PHP_EOL ?></div></span></div></div></div></div></div></div>
      <div class="life_chartaddText" style="position: absolute; top: 0px; left: 0px;"></div>
    </div>
    <script type="text/javascript">
      $(document).ready(function() {
        donut_right_text_chart({"labels":{"left":[],"right":[]},"data":[{"order":1,"label":"<b>1. Servir Dieu<\/b>","score":9},{"order":2,"label":"<b>2. Intégrité<\/b>","score":8},{"order":3,"label":"<b>3. Famille<\/b>","score":7},{"order":4,"label":"<b>4. Servir les autres<\/b>","score":6},{"order":5,"label":"5. Accomplissement","score":5},{"order":6,"label":"6. Gagner de l'argent","score":4},{"order":7,"label":"7. Amis","score":3},{"order":8,"label":"8. Loisirs","score":2},{"order":9,"label":"9. Esthétique","score":1}],"title":"Valeurs de Vie"}, "life_chart");
      });
    </script>
    <h4 class="cdreport-header cdreport-header-alt">CI-DESSOUS SONT LISTES VOS QUATRE PRIORITES DE VIE LES PLUS IMPORTANTES</h4>
  </div>
  ...
  <div class="col-lg-6 card-competences-metier mb-4">
    ...
    <div class="card mb-6 bg-light-vert custom-card">
      <div class="card-body">
        <h4 class="card-title bg-vert">Servir Dieu</h4>
  ...
  <div class="col-lg-6 card-competences-metier mb-4">
    ...
    <div class="card mb-6 bg-light-rose custom-card">
      <div class="card-body">
        <h4 class="card-title bg-rose">Intégrité</h4>

        <ul class="card-text">
          <ul>
          <li>
            <p><?php echo $documents[117]->nodeValue, PHP_EOL ?> &nbsp;</p>
          </li>
          </ul>
        </ul>
      </div>
  ...
  <div class="col-lg-6 card-competences-metier mb-4">
    ...
    <div class="card mb-6 bg-light-rose custom-card">
      <div class="card-body">
        <h4 class="card-title bg-rose">Famille</h4>

        <ul class="card-text">
          <ul>
          <li>
            <p><?php echo $documents[118]->nodeValue, PHP_EOL ?></p>
          </li>
          </ul>
        </ul>
      </div>
  ...
  <div class="col-lg-6 card-competences-metier mb-4">
    ...
    <div class="card mb-6 bg-light-vert custom-card">
      <div class="card-body">
        <h4 class="card-title bg-vert">Servir les autres</h4>

        <ul class="card-text">
          <ul>
          <li>
            <p><?php echo $documents[119]->nodeValue, PHP_EOL ?></p>
          </li>
          </ul>
        </ul>
      </div>
