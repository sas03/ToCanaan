@extends('layouts.master') @section('title', 'Espace professionnels') @section('content')

<div class="row">

  <div class="col-lg-12 box-titres">
    <h4 class="text-uppercase">Espace Professionnels</h4>
  </div>
...
<div class="row justify-content-center">
  <div class="col-md-6 box-form">
    ...
    <form class="form-horizontal" method="POST" action="{{ route('ecole_login') }}">
        {{ csrf_field() }}
...
<div class="row justify-content-center">
  ...
  <div class="col-md-6 box-form">
    ...
    <a class="btn bg-jaune btn-inscription" href="{{ route('ecole_register') }}">
        S'inscrire
    </a>
  </div>
</div>
